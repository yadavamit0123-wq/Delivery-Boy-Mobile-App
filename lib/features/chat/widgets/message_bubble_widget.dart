...
class MessageBubbleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String? image = _getAvatarImage(userTypeIndex: Get.find<ChatController>().userTypeIndex);
          ...
          child: Column(crossAxisAlignment: isMe ? CrossAxisAlignment.end:CrossAxisAlignment.start, children: [
            Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                mainAxisAlignment: isMe ? MainAxisAlignment.end : MainAxisAlignment.start, children: [
                  ...
                  !_isUserAvatarActive(isMe, isSameUserWithPreviousMessage, chatController) ? SizedBox(width: Dimensions.paddingSizeOverLarge) : const SizedBox(),
            ...
            Padding(
              padding: EdgeInsets.only(left: isMe ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeExtraLarge + 10, right: Dimensions.paddingSizeSmall),
  ...
  String? _getAvatarImage({required int userTypeIndex}) {
    ...
    message.sellerInfo?.shops![0].imageFullUrl?.path ?? '' : '' : userTypeIndex == 1 ?
    message.customer?.imageFullUrl?.path ?? '' : Get.find<SplashController>().configModel?.inHouseShop?.imageFullUrl?.path ?? '';
  }

  bool _isUserAvatarActive(bool isMe, bool isSameUserWithPreviousMessage, ChatController chatController) =>
    ...
    return Column(crossAxisAlignment: isMe ? CrossAxisAlignment.end : CrossAxisAlignment.start, children: [
      ...
      Padding(
        ...
        child: Directionality(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isMe ? 50 : 5, right: isMe ? 0 : 50),
            child: GridView.builder(
              ...
              itemBuilder: (context, index){
                return _FileItem(file: files[index]);
              }
            ),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(width: 180, height: 60,
          decoration: BoxDecoration(color: Theme.of(context).hintColor.withValues(alpha:0.15),
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text("${file.size}", style: rubikRegular.copyWith(
...
class _MessageTime extends StatelessWidget {
  ...
  const _MessageTime({required this.chatController, required this.message});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        child: Padding(
          padding: EdgeInsets.only(
            top: chatController.onMessageTimeShowID == message.id.toString() ? Dimensions.paddingSizeExtraSmall : 0.0,
          ),
          child: Text(
            chatController.getOnPressChatTime(message) ?? "",
                      ...
                      child: InkWell(
                        ...
                        child: ClipRRect(
                            ...
                            child:Container(
                              ...
                              child: Center(child: Text("+${widget.images.length-3}", style: rubikRegular.copyWith(color: Colors.white))),
                            )),
                      ),
                    )),
                ]);
