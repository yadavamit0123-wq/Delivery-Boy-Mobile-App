  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      widget.reverse ? const SizedBox() : widget.itemView,
       ...
       widget.totalSize == null || _offset! >= (widget.totalSize! / widget.limit).ceil() || _offsetList.contains(_offset!+1) ? const SizedBox() : Center(child: Padding(
        padding: (_isLoading ) ?  EdgeInsets.all(Dimensions.paddingSizeSmall) : EdgeInsets.zero,
