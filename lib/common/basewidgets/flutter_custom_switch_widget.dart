...
class FlutterCustomSwitchWidget extends StatefulWidget {
  ...
  const FlutterCustomSwitchWidget({
    super.key,
    required this.value,
...
class _FlutterCustomSwitchWidgetState extends State<FlutterCustomSwitchWidget>
  ...
  @override
  void didUpdateWidget(FlutterCustomSwitchWidget oldWidget) {
  ...
  FontWeight get _activeTextFontWeight =>
      widget.activeTextFontWeight ?? FontWeight.w500;
  FontWeight get _inactiveTextFontWeight =>
      widget.inactiveTextFontWeight ?? FontWeight.w500;
